...
class PostOffice:
    ...
    def have_message(self, receiver: str) -> bool:
    ...
    def get_message(self, receiver: str) -> Buffer:
    ...
    def deposit(self, receiver: str, message: Buffer) -> None:
    ...
    def _ensure_outbox_exists(self, receiver: str) -> None:
